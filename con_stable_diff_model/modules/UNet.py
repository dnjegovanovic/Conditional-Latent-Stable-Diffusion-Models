...
from con_stable_diff_model.models.TimeEmbedding import (
    TimeEmbedding,
    time_embedding_fun,
...
class UNet(nn.Module):  # Defines the core UNet architecture used by the diffusion model
    ...
    def __init__(
        ...
        for idx in reversed(
            ...
            out_channels = (
                self.down_channels[idx - 1] if idx != 0 else 16
            )  # Defines decoder output channels, capping the final stage at 16 channels
        ...
        self.conv_out = nn.Conv2d(
            16, self.in_channels, kernel_size=3, padding=1
